...
class FeatureRepository(t.Protocol[P, R]):  # bentoml.Runnable,
    ...
    def get_many(self, pks: t.List[P], with_ttl=False, options: dict[str, t.Any] = None) -> t.List[t.Optional[R]]: ...

    def get(self, pk: P, with_ttl=False, options: dict[str, t.Any] = None) -> R: ...
